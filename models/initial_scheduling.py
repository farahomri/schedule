...
def find_missing_sap_numbers(plannification_df, products_classified_df):
    try:
        ...
        if missing_materials.empty:
            ...
            return missing_materials.tolist()
...
def calculate_working_time(technicians_path, shifts_df):
    ...
    working_technicians['Break'] = working_technicians['Break'].fillna(0)
    working_technicians['Extra Time'] = working_technicians['Extra Time'].fillna(0)
